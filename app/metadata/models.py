...
class Item(models.Model):
    ...
    general_content = models.CharField(max_length=11, choices=CONTENT_CHOICES, blank=True) # to be partially automated based on filetype of documents
    ...
    educational_materials = models.TextField(blank=True)
    music = models.TextField(blank=True)
    descriptive_materials = models.TextField(blank=True)
    added = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    modified_by = models.CharField(max_length=255)
    class Meta:
