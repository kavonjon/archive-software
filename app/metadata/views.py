                    ...
                    for collaborator_index, collaborator_role_index in indexes:
                        if is_valid_param(collaborator_index):
                            ...
                            if is_valid_param(collaborator_value):
                                ...
                                collaborator_role = CollaboratorRole.objects.get(item=item, collaborator=collaborator) #create collaborator role object based on collaborator, regardless of value
