...
| Languoid list (client load-all, tree pagination—**languoid-only**) | `02-PATTERNS/frontend.md`, `04-REFERENCE/frontend/languoid-list-implementation.md` |
...
**Last updated:** 2026-04-23 (revise whenever the index triad or pattern layout changes)
