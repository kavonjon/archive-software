/**
 * Export Button Component for Item List
 * 
 * Split button with dropdown for exporting items to Excel:
...
interface ItemExportButtonProps {
  mode: ExportMode;
...
const ItemExportButton: React.FC<ItemExportButtonProps> = ({
  mode,
  exportStatus,
  onModeChange,
  onExecute,
  ...
  const handleMenuItemClick = (selectedMode: ExportMode) => {
    ...
    localStorage.setItem('item-export-mode', selectedMode);
...
export default ItemExportButton;
