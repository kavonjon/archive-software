/**
 * Export Button Component for Languoid List
 * 
 * Split button with dropdown for exporting languoids to Excel:
...
const ExportButton: React.FC<ExportButtonProps> = ({
  ...
  const handleMenuItemClick = (selectedMode: ExportMode) => {
    ...
    localStorage.setItem('languoid-export-mode', selectedMode);
